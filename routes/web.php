...
use App\Http\Controllers\Frontend\ArtistPageController;
...
Route::group(['namespace' => 'Frontend', 'as' => 'frontend.'], function () {
    ...
    Route::get('artis', 'ArtistPageController@index')->name('artist.index');
    Route::get('composer', 'ComposerPageController@index')->name('composer.index');
    Route::get('song', 'SongPageController@index')->name('song.index');
    Route::get('coversong', 'CoverSongPageController@index')->name('coversong.index');
    Route::get('partner', 'PartnerPageController@index')->name('partner.index');
    Route::get('contact', 'ContactPageController@index')->name('contact.index');
    Route::get('daftar', 'RegisterPageController@index')->name('daftar.index');
    Route::get('loginfront', 'LoginPageController@index')->name('logins.index');
