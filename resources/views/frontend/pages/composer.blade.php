                    ...
                    <div class="new-hits-area">
                        ...
                        <form action="">
                          <div class="p-1 bg-white rounded rounded-pill shadow-sm mb-4">
                            <div class="input-group">
                              <input type="search" placeholder="Cari berdasarkan pencipta" aria-describedby="button-addon1" class="form-control border-0 bg-light">
                        ...
                        <div class="single-new-item d-flex align-items-center justify-content-between wow fadeInUp" data-wow-delay="100ms">
                            <div class="first-part d-flex align-items-center">
                                ...
                                <div class="content-">
                                    <h6>Ipank</h6>
                                    <small>Bergabung pada 14 10 2022</small>
                                    <p>Jumlah Cover #999</p>
                                </div>
                            </div>
                            <div class="second-part">
                                <div class="content-">
                                    <p>Karya Cipta: <b>400</b></p>
                                </div>
                            </div>
                        </div>
